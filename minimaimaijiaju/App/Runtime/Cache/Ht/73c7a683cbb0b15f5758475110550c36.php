...
<script type="text/javascript" src="/minibuysalejiaju/Public/ht/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/minibuysalejiaju/Public/ht/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
</head>
<body>
         ...
         <li data-index="0">
            ...
            <!-- <iframe class="pro_2" src="/minibuysalejiaju/Data/inc/photo_add.php?id=photo_sj0&width=200&height=200" frameborder="0"></iframe> -->
              <?php if ($cate_info['bz_1']) { ?>
                <img src="/minibuysalejiaju/Data/<?php echo $cate_info['bz_1']; ?>" width="200" height="200" />
              <?php } ?>
