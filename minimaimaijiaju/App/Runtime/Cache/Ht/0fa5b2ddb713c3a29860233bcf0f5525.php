...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li>
            <div style="color:#c00; font-size:14px; padding-left:20px;">上传图片大小：200px*200px,格式为jpg、jpeg、png</div>
         </li>
         <li data-index="'.$key.'">
            <div class="d1">资讯图片:</div>
            <div>
              <?php if($news['photo'] != ''): ?><img src="/minibuysalejiaju/Data/<?php echo $news['photo']; ?>" /><?php endif; ?>
