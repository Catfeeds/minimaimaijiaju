...
<script type="text/javascript" src="/minibuysalejiaju/Public/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/minibuysalejiaju/Public/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
<script>
         ...
         <li>
            ...
            <div>
              <?php if ($shangchang['logo']) { ?>
                  <img src="/minibuysalejiaju/Data/<?php echo $shangchang['logo']; ?>" width="80" height="80" style="margin-bottom: 3px;" /><br />
              <?php } ?>
         ...
         <li>
            ...
            <div>
              <?php if ($shangchang['vip_char']) { ?>
                  <img src="/minibuysalejiaju/Data/<?php echo $shangchang['vip_char']; ?>" width="240" height="80" style="margin-bottom: 3px;" /><br />
              <?php } ?>
