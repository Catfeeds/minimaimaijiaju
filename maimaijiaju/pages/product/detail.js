...
// tab切换
  ...
  onShareAppMessage: function (res) {
    var that = this;
    return {
      title: that.data.itemData.name,
      desc: that.data.itemData.intro,
      path: '/pages/product/detail?productId=' + that.data.itemData.id,
      success: function (res) {
        // 分享成功
      },
      fail: function (res) {
  ...
  getVou:function (event) {
    var proid = event.currentTarget.dataset.proid;
    wx.navigateTo({
      url: '../ritual/ritual?proid='+proid
    });
  }
});
